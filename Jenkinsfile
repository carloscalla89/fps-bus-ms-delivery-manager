...
stages {
  ...
  env.EXTRAS = "-Dsonar.sources=./src/ -Dsonar.sourceEncoding=UTF-8 -Dsonar.java.source=8 -Dsonar.java.binaries=target/classes -Dsonar.language=java -Dsonar.java.libraries=target/dependency"
