...
public interface Constant {
    ...
    enum OrderStatusInkatracker {
        ...
        ATTEMPT_TRACKER_CREATE("15","CONFIRMED"), UPDATE_TRACKER_BILLING("16","ON_STORE"),
        UPDATE_RELEASE_ORDER("16","ON_STORE"), NOT_FOUND_ACTION("-1","NOT_FOUND_ACTION"), CREATE_ORDER("15","CONFIRMED"),
